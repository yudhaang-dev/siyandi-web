            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('panel.villages.index') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Kelurahan Desa</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a class="btn btn-primary" href="{{ route('panel.villages.create') }}">Tambah</a>
            </div>
        </div>
    </div>
@endsection
...
$(function(){
    const dt = $('#dt').DataTable({
        ...
        columns : [
            ...
            { data: 'district.city.province.name' },
            { 
                data: 'id',
