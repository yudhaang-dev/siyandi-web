            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('panel.cities.index') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Kota Kabupaten</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a class="btn btn-primary" href="{{ route('panel.cities.create') }}">Tambah</a>
            </div>
        </div>
    </div>
@endsection
